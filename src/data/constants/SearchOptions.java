...
public final class SearchOptions {
    ...
    public static final String[] DB_USER_KEYS = {VehicleOwner.ID,VehicleOwner.FIRST_NAME,VehicleOwner.LAST_NAME,VehicleOwner.AGE,VehicleOwner.COMPANY_TITLE,VehicleOwner.COMPANY_ID,
                                                    VehicleOwner.COMPANY_TAX_DEDUCTION,VehicleOwner.TYPE};
}
